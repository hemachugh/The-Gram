...
const {
  ...
  saveUnsavePost,
  getPostDetails,
  getPostsIncludingUser,
  getPostsForUserAndFollowing,
...
router
  .route("/post/new")
  .post(isAuthenticated, uploadPost.single("post"), newPost);

router.route("/posts/all").get(allPosts);

router.route("/posts").get(isAuthenticated, getPostsForUserAndFollowing);
